...
import { createToolResponse, formatTasksResult } from "../../utils/responses.js";
...
const schema = z.object({
  ...
  path: z.string()
    ...
    .describe("Relative path of the note to search for tasks (e.g., 'folder/note.md')"),
}).strict();
  ...
  return createTool<GetTasksInput>({
    ...
    handler: async (args, vaultPath, _vaultName) => {
      try {
        ...
        console.error(`Error getting tasks from note '${args.path}' in vault '${args.vault}':`, error);
